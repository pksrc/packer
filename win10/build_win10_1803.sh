...
echo "Building Windows 10 1803 OVA Appliance ..."
...
if [[ "$1" -gt "-1" ]] && [[ $1 == "dev" ]]; then
    ...
    --var iso_url=packer_cache/en_windows_10_business_edition_version_1803_updated_april_2019_x64_dvd_b91b0da3.iso \
    --var vm_name="Windows10_1803" \
    windows_10.json
else
