...
if exist "C:\Users\vmuser\windows.iso" (
    move /Y C:\Users\vmuser\windows.iso C:\Windows\Temp
)
...
if exist "C:\Users\vmuser\VBoxGuestAdditions.iso" (
    move /Y C:\Users\vmuser\VBoxGuestAdditions.iso C:\Windows\Temp
)
...
:parallels
if exist "C:\Users\vmuser\prl-tools-win.iso" (
	move /Y C:\Users\vmuser\prl-tools-win.iso C:\Windows\Temp
