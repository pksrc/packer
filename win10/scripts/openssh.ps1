...
Write-Output "Setting vmuser user file permissions"
New-Item -ItemType Directory -Force -Path "C:\Users\vmuser\.ssh"
C:\Windows\System32\icacls.exe "C:\Users\vmuser" /grant "vmuser:(OI)(CI)F"
C:\Windows\System32\icacls.exe "C:\Program Files\OpenSSH\bin" /grant "vmuser:(OI)RX"
C:\Windows\System32\icacls.exe "C:\Program Files\OpenSSH\usr\sbin" /grant "vmuser:(OI)RX"
...
# disabled for vcloud to make vmuser-serverspec work
...
Write-Output "Removing ed25519 key as vmuser net-ssh 2.9.1 does not support it"
...
C:\Windows\System32\icacls.exe "C:\Windows\Temp" /grant "vmuser:(OI)(CI)F"
...
Set-Content C:\Users\vmuser\.ssh\environment $sshenv
